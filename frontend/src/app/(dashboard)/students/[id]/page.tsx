    ...
    <div className="space-y-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">ID: #{student.id} • Rol: O&apos;quvchi</p>
            </div>
          </div>
        </div>

        {/* Contact info grid */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100 text-sm">
          ...
          <div className="flex items-center gap-2.5 text-gray-600">
            ...
            <div>
              ...
              <p className="font-medium text-gray-800">{student.email || 'Kiritilmagan'}</p>
            </div>
          </div>
          <div className="flex items-center gap-2.5 text-gray-600">
            <Calendar className="w-4 h-4 text-gray-400" />
            <div>
              <p className="text-xs text-gray-400">Ro&apos;yxatdan o&apos;tgan</p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 pb-4">
          <div>
            <h2 className="text-base font-bold text-gray-900">Biriktirilgan Guruhlar</h2>
            <p className="text-xs text-gray-400">O&apos;quvchi ta&apos;lim olayotgan kurslar</p>
          </div>
        ...
        {groups.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            {groups.map((g) => (
              <div
                key={g.membership_id}
                className="p-4 rounded-xl border border-gray-100 bg-gray-50/50 hover:bg-gray-50 transition flex items-start justify-between"
              >
                <div>
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Kurs: {g.course_name}</p>
                  <p className="text-xs text-gray-500">O&apos;qituvchi: {g.teacher_name}</p>
                  <p className="text-[11px] text-gray-400 mt-2">Qo&apos;shilgan: {g.enrolled_at}</p>
                </div>
